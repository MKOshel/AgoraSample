...
- (void)setUpUI
{
    ...
    self.backgroundColor = RGB(yellow0);//[UIColor clearColor];
    ...
    [_lblTitle setTextColor:RGB(blue_back)];
    ...
    [_lblMessage setTextColor:RGB(blue_back)];
...
- (void)showNotificationViewWithImage:(UIImage *)image title:(NSString *)title message:(NSString *)message isAutoHide:(BOOL)isAutoHide duration: (double) duration onTouch:(void (^)())onTouch
{
    if(![NSThread isMainThread])
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            [self showNotificationViewWithImage:(UIImage *)image title:(NSString *)title message:(NSString *)message isAutoHide:(BOOL)isAutoHide duration:(double) duration onTouch:(void (^)())onTouch];
        });
        return;
    }
...
{
    [HDNotificationView showNotificationViewWithImage:image title:title message:message isAutoHide:YES duration:NOTIFICATION_VIEW_SHOWING_DURATION onTouch:nil];
}
...
{
    [HDNotificationView showNotificationViewWithImage:image title:title message:message isAutoHide:isAutoHide duration:NOTIFICATION_VIEW_SHOWING_DURATION onTouch:nil];
}
+ (void)showNotificationViewWithImage:(UIImage *)image title:(NSString *)title message:(NSString *)message isAutoHide:(BOOL)isAutoHide duration:(double)duration onTouch:(void (^)())onTouch
{
    [[HDNotificationView sharedInstance] showNotificationViewWithImage:image title:title message:message isAutoHide:isAutoHide duration:duration onTouch:onTouch];
}
